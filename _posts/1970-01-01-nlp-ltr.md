...
- [应用](#应用)
    - [美团点评的lambdarank](#美团点评的lambdarank)
        - [用户ID的Embedding](#用户id的embedding)
        - [lambdadnn的使用](#lambdadnn的使用)
...
参考刘铁岩老师的书[Learning to Rank for Information Retrieval](https://www.cda.cn/uploadfile/image/20151220/20151220115436_46293.pdf)和李航老师的书[Learning to rank for information retrieval and natural language processing](http://www.iro.umontreal.ca/~nie/IFT6255/Books/Learning-to-rank.pdf)，对比各种wise的优缺点：[https://blog.csdn.net/lipengcn/article/details/80373744](https://blog.csdn.net/lipengcn/article/details/80373744)
