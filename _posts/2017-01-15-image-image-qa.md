...
- [数据准备](#数据准备)
    - [数据介绍与下载](#数据介绍与下载)
        - [下载MSCOCO数据](#下载mscoco数据)
    - [下载图片－q/a的标注数据集](#下载图片qa的标注数据集)
            - [英文qa:](#英文qa)
        - [中文qa:](#中文qa)
...
[1] Gao H, Mao J, Zhou J, et al. [Are you talking to a machine? dataset and methods for multilingual image question](http://papers.nips.cc/paper/5641-are-you-talking-to-a-machine-dataset-and-methods-for-multilingual-image-question)[C]//Advances in Neural Information Processing Systems. 2015: 2296-2304.
